...
//        likeAnimate = holder.likeAnimate;
//        no_likes = holder.no_likes;
//        no_comments = holder.no_comments;
//        commentBtn = holder.commentBtn;
//        profile_img = holder.profile_img;
//        name = holder.name;
//        followBtn = holder.followBtn;
...
//        titled = mediaObjects.get(targetPosition).getTitle();
//        user_id = mediaObjects.get(targetPosition).getUser_id();
